...
describe("Edge cases from fuzz testing", () =>
{
  ...
  {
    /*
     * Counterexample: [[{"type":"set","key":"","value":[[false,"<=rH","<=rH",true,"b;i63MU5#"]]}]]
     * Simplified: setting a key to an array containing an array with mixed types.
     */
  ...
  {
    /*
     * Counterexample: [[["",{"x,":{"P9O":"o","2A47 m":[true,[true,"4 "],[680436100448947,null,"","",-7185039365749484,false,1242072609498249],["","",1242072609498249]]},"":{}}]]]
     * Simplified key-value pair
     */
    const key = "";
    const value = { "x,": { "P9O": "o", "2A47 m": [ true, [ true, "4 " ], [ 680436100448947, null, "", "", -7185039365749484, false, 1242072609498249 ], [ "", "", 1242072609498249 ] ], }, "": {}, };
  ...
  it("Reproduction: Array update [\"b>Jz0\", 0] -> [\"b>Jz0\", \"b>Jz0\"]", () =>
  {
    const a = [ "b>Jz0", 0 ];
    const b = [ "b>Jz0", "b>Jz0" ];
